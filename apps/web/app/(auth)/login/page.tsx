				...
				<div className="hidden lg:flex flex-col justify-between p-12 bg-slate-900 text-white relative overflow-hidden">
					...
					<div className="relative z-10 space-y-6">
						<h2 className="text-4xl font-black leading-tight tracking-tighter">
							...
							<span className="text-blue-400">medical history.</span>
						</h2>
						<p className="text-slate-400 font-medium leading-relaxed max-w-sm">
							Sign in to initiate the AWS KMS decryption protocol and access
						...
						<div className="flex flex-col gap-4 pt-4">
							<AuthFeature
								...
								text="AES-256 Envelope Encryption"
							/>
							<AuthFeature
								icon={<Fingerprint className="h-4 w-4" />}
								text="Hedera Consensus Validation"
							/>
							<AuthFeature
								icon={<KeyRound className="h-4 w-4" />}
								text="Identity-Linked Master Keys"
							/>
						</div>
					</div>
